    ...
    )
{
	...
	KdPrint(("FileDisk: Startup\n"));
	DbgPrint(("FileDisk: Startup\n"));
            ...
            case IRP_MJ_READ:

				{
					...
					if (len && NT_SUCCESS(st)) {
						...
						case 3://AES128
						case 4://AES192
							sect.li.QuadPart = io_stack->Parameters.Read.ByteOffset.QuadPart >> 9;
